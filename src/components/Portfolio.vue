    ...
    <div class="px-4 my-5 text-center border-bottom">
      ...
      <div class="col-lg-6 mx-auto">
        ...
        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
          <a class="btn btn-primary btn-lg px-4 me-sm-3" href="https://storage.remzi.info/assets/docs/Onderzoeksverslag-van-R.Cavdar-20-01-2023.pdf"
      ...
      <div class="overflow-hidden" style="max-height: 30vh;">
        <div class="container px-5">
          <a href="https://storage.remzi.info/assets/docs/Onderzoeksverslag-van-R.Cavdar-20-01-2023.pdf"
            ...
            <img src="https://storage.remzi.info/assets/images/cover.png" class="img-fluid border rounded-3 shadow-lg mb-4 cover-image"
